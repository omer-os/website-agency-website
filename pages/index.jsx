...
export default function Index() {
  ...
  return (
    <section className="text-white h-[80vh] flex items-center ">
      <div className="max-w-screen-xl px-4 mx-auto lg:items-center lg:flex">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-3xl font-extrabold text-transparent sm:text-5xl bg-clip-text bg-gradient-to-r from-green-300 via-blue-500 to-purple-600">
            نحن نبني مواقع{" "}
            <span className="sm:block">ويب نظيفة, فعالة و سريعة</span>
          </h1>

          <p className="max-w-xl mx-auto mt-4 sm:leading-relaxed text-xs xs:text-sm">
            Lorem ipsum, dolor Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eum, tenetur? sit amet consectetur
          </p>
